...
const DigitalAgencyWorkflow = () => {
  useEffect(() => {
    if (typeof window !== "undefined") {
      let tHero = gsap.context(() => {
        // Animate from right to left for RTL (x: +20)
  ...
  return (
    <>
      <section className="workflow__area rtl">
          ...
          <div className="row">
            ...
            <div className="col-xxl-12 workflow__slider">
              <Swiper
                ...
                loop={true}
                speed={2000}
                rtl={true} // Enable RTL for Swiper
                breakpoints={{
                  640: {
                    slidesPerView: 2,
                  },
      ...
      <style jsx>{`
        /* Add RTL direction and text alignment */
        .rtl {
          direction: rtl;
          text-align: right;
        }
        /* If needed, override flexbox or grid directions here */
        .workflow__slide {
          /* Example: align items right for RTL */
          text-align: right;
        }
      `}</style>
    </>
