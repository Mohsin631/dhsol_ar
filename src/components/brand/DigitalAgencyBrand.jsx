...
const DigitalAgencyBrand = () => {
  ...
  return (
    <>
      <section className="brand__area rtl">
          ...
          <div className="row">
            ...
            <div className="col-xxl-12">
              <div className="brand__list">
                ...
                <div className="brand__item fade_bottom">
                  <Image priority width={114} height={64} src={Brand4} alt="Brand Logo" />
                </div>
                <div className="brand__item fade_bottom">
                  <Image priority width={114} height={64} src={Brand5} alt="Brand Logo" />
                </div>
                <div className="brand__item fade_bottom">
                  <Image priority width={114} height={64} src={Brand6} alt="Brand Logo" />
                </div>
                <div className="brand__item fade_bottom">
                  <Image priority width={114} height={64} src={Brand7} alt="Brand Logo" />
                </div>
                <div className="brand__item fade_bottom">
                  <Image priority width={114} height={64} src={Brand8} alt="Brand Logo" />
                </div>
                <div className="brand__item fade_bottom">
                  <Image priority width={114} height={64} src={Brand9} alt="Brand Logo" />
                </div>
                <div className="brand__item fade_bottom">
                  <Image priority width={114} height={64} src={Brand10} alt="Brand Logo" />
                </div>
                <div className="brand__item fade_bottom">
                  <Image priority width={114} height={64} src={Brand11} alt="Brand Logo" />
                </div>

                <div className="brand__item fade_bottom">
                  <Image priority width={85} height={67} src={Brand12} alt="Brand Logo" />
                </div>
              </div>
            </div>
          </div>
        ...
        <style jsx>{`
          ...
          .rtl .brand__list {
            ...
            flex-wrap: wrap;
            gap: 20px;
            justify-content: flex-end; /* Align brands to right for RTL */
            flex-direction: row-reverse; /* Reverse brand order */
          }
          .brand__item {
            /* Optional: adjust margin or alignment */
          }
        `}</style>
      </section>
    </>
