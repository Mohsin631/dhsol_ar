              ...
              <div className="col-xxl-4 col-xl-5 col-lg-5 col-md-6">
                <div className="sec-title-wrapper portfolio__title-wrap-6">
                  <div className="">
                    ...
                    <p>
                      عرض دراسة حالة كاملة لأعمالنا المميزة والرائعة التي أنشأناها لعملائنا مؤخرًا.
                    </p>
                  </div>
                  ...
                  <div className="portfolio__list-6" ref={portfolioItemList}>
                    <div className="portfolio__item-6" data-portfitem="1">
                      <Link href="/portfolio-details">
                        ...
                        <div className="portfolio__content-6">
                          <h4 className="portfolio__title-6">VIBEATS</h4>
                    ...
                    <div className="portfolio__item-6" data-portfitem="2">
                      <Link href="/portfolio-details-2">
                        ...
                        />
                        <div className="portfolio__content-6">
                          <h4 className="portfolio__title-6">KOBI Education</h4>
                          <h5 className="portfolio__date">2024</h5>
                        </div>
                      </Link>
                    </div>
                    ...
                    <div className="portfolio__item-6" data-portfitem="3">
                      <Link href="/portfolio-details-3">
                        ...
                        />
                        <div className="portfolio__content-6">
                          <h4 className="portfolio__title-6">THE MIX KUWAIT</h4>
                          <h5 className="portfolio__date">2024</h5>
                        </div>
                      </Link>
                    </div>
                    ...
                    <div className="portfolio__item-6" data-portfitem="4">
                      <Link href="/portfolio-details-4">
                        ...
                        />
                        <div className="portfolio__content-6">
                          <h4 className="portfolio__title-6">دبي ديوتي فري</h4>
                          <h5 className="portfolio__date">2024</h5>
                        </div>
                      </Link>
                    </div>
                    ...
                    <div className="portfolio__item-6" data-portfitem="6">
                      <Link href="/portfolio-details-6">
                        ...
                        />
                        <div className="portfolio__content-6">
                          <h4 className="portfolio__title-6">ONE NETWORK</h4>
                          <h5 className="portfolio__date">2024</h5>
                        </div>
                      </Link>
                    </div>
                    ...
                    <div className="portfolio__item-6" data-portfitem="7">
                      <Link href="/portfolio-details-7">
                        ...
                        />
                        <div className="portfolio__content-6">
                          <h4 className="portfolio__title-6">SMILE TAXI</h4>
                          <h5 className="portfolio__date">2024</h5>
                        </div>
                      </Link>
                    </div>
