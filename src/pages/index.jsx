// pages/index.js or index.tsx (Arabic Version)
...
const DigitalAgency = () => {
  ...
  return (
    <div dir="rtl">
      <Head>
        <title>DH Solutions - شركة تطوير برمجيات مخصصة في الولايات المتحدة ومنطقة الشرق الأوسط وشمال أفريقيا</title>
        <meta
          name="description"
          content="تقدم DH Solutions حلول برمجية مخصصة رفيعة المستوى، بالإضافة إلى حلول الذكاء الاصطناعي والتحول الرقمي لتمكين الشركات حول العالم. تعاون معنا للتحول الرقمي المبتكر والقابل للتوسع."
        />
        <meta
          name="viewport"
